...
async def help_cmd(interaction: discord.Interaction):
    ...
    try:
        ...
        embed = discord.Embed(
            ...
            description="Manage your shop inventory and earnings.",
            color=COLORS['INFO']
        )
        ...
        stock_commands = [
            ...
            "`/bulkadd2` - Add multiple items visually (category by category).", # Renamed command? Assumed name
        ...
        if is_admin_user:
            admin_commands = [
                ...
                "`/backup` - Create a manual data backup."
            ]
            embed.add_field(name="⚙️ Admin Commands", value="\n".join(admin_commands), inline=False)

        embed.set_footer(text="Use Tab for item name autocomplete in commands.")
